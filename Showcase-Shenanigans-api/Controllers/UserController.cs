        ...
        public IActionResult Login([FromBody] User User)
        {
            ...
            if (CurrentUser != null)
            {
                ...
                if (validator.validate())
                {
                    ...
                    return Ok(new { Token = token, user = new { email = CurrentUser.Email, id = CurrentUser.Id, role = CurrentUser.Role, firstName = CurrentUser.FirstName, lastName = CurrentUser.LastName } });
